...
const EDW_TAXONOMY = [
    ...
    },
    {
        ...
        apcCategory: 'body',
        assemblies: [
            { name: 'Left Front Door', parts: ['Complete Door (Front Left)', 'Door Skin (Front Left)', 'Window Glass (Front Left)', 'Window Regulator — Electric (Front Left)', 'Window Regulator — Manual (Front Left)', 'Window Motor (Front Left)', 'Door Mirror (Left)', 'Mirror Glass (Left)', 'Mirror Motor (Left)', 'Door Handle — Outer (Front Left)', 'Door Handle — Inner (Front Left)', 'Door Lock / Latch (Front Left)', 'Door Lock Actuator (Front Left)', 'Door Card / Trim Panel (Front Left)', 'Door Weatherstrip / Seal (Front Left)', 'Door Hinge — Upper (Front Left)', 'Door Hinge — Lower (Front Left)', 'Window Switch (Front Left)'] },
            { name: 'Right Front Door', parts: ['Complete Door (Front Right)', 'Door Skin (Front Right)', 'Window Glass (Front Right)', 'Window Regulator — Electric (Front Right)', 'Window Regulator — Manual (Front Right)', 'Window Motor (Front Right)', 'Door Mirror (Right)', 'Mirror Glass (Right)', 'Mirror Motor (Right)', 'Door Handle — Outer (Front Right)', 'Door Handle — Inner (Front Right)', 'Door Lock / Latch (Front Right)', 'Door Lock Actuator (Front Right)', 'Door Card / Trim Panel (Front Right)', 'Door Weatherstrip / Seal (Front Right)', 'Door Hinge — Upper (Front Right)', 'Door Hinge — Lower (Front Right)', 'Window Switch (Front Right)'] },
            { name: 'Left Rear Door', parts: ['Complete Door (Rear Left)', 'Door Skin (Rear Left)', 'Window Glass (Rear Left)', 'Window Regulator — Electric (Rear Left)', 'Window Regulator — Manual (Rear Left)', 'Window Motor (Rear Left)', 'Door Handle — Outer (Rear Left)', 'Door Handle — Inner (Rear Left)', 'Door Lock / Latch (Rear Left)', 'Door Lock Actuator (Rear Left)', 'Door Card / Trim Panel (Rear Left)', 'Door Weatherstrip / Seal (Rear Left)', 'Door Hinge — Upper (Rear Left)', 'Door Hinge — Lower (Rear Left)'] },
            { name: 'Right Rear Door', parts: ['Complete Door (Rear Right)', 'Door Skin (Rear Right)', 'Window Glass (Rear Right)', 'Window Regulator — Electric (Rear Right)', 'Window Regulator — Manual (Rear Right)', 'Window Motor (Rear Right)', 'Door Handle — Outer (Rear Right)', 'Door Handle — Inner (Rear Right)', 'Door Lock / Latch (Rear Right)', 'Door Lock Actuator (Rear Right)', 'Door Card / Trim Panel (Rear Right)', 'Door Weatherstrip / Seal (Rear Right)', 'Door Hinge — Upper (Rear Right)', 'Door Hinge — Lower (Rear Right)'] },
